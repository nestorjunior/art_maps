defmodule ArtMaps.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, ArtMaps.Repo)
  ...
  """
  def valid_password?(%ArtMaps.Accounts.User{hashed_password: hashed_password}, password)
  ...
  def profile_changeset(user, attrs) do
    user
    |> cast(attrs, [:full_name, :phone, :bio])
