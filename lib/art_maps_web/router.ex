defmodule ArtMapsWeb.Router do
  use ArtMapsWeb, :router

  import ArtMapsWeb.UserAuth
  ...
  scope "/", ArtMapsWeb do
    ...
    live_session :default,
      on_mount: [{ArtMapsWeb.UserAuth, :mount_current_scope}] do
      live("/", MapLive, :index)
      live("/map", MapLive, :index)
    end
  end

  scope "/admin", ArtMapsWeb do
  ...
  if Application.compile_env(:art_maps, :dev_routes) do
  ...
  scope "/", ArtMapsWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ArtMapsWeb.UserAuth, :require_authenticated}] do
